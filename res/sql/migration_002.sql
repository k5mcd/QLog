...
ALTER TABLE contacts ADD clublog_qso_upload_status CHECK(clublog_qso_upload_status IN ('N', 'Y', 'M'));
...
ALTER TABLE contacts ADD eqsl_qsl_rcvd CHECK(eqsl_qsl_rcvd IN ('N', 'Y', 'R', 'I'));
ALTER TABLE contacts ADD eqsl_qsl_sent CHECK(eqsl_qsl_sent IN ('N', 'Y', 'R', 'I'));
...
ALTER TABLE contacts ADD hrdlog_qso_upload_status CHECK(hrdlog_qso_upload_status IN ('N', 'Y', 'R', 'I'));
...
ALTER TABLE contacts ADD qrzcom_qso_upload_status CHECK(qrzcom_qso_upload_status IN ('N', 'Y', 'M'));
