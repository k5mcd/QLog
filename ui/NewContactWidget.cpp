    ...
    isManualEnterMode(false)
{
    ...
    potaCompleter = new QCompleter(Data::instance()->potaIDList(), uiDynamic->potaEdit);
    ...
    sotaCompleter = new QCompleter(Data::instance()->sotaIDList(), uiDynamic->sotaEdit);
...
void NewContactWidget::sotaEditFinished()
{
    ...
    if ( sotaInfo.summitCode.toUpper() == uiDynamic->sotaEdit->text().toUpper()
         && !sotaInfo.summitName.isEmpty() )
    {
    ...
    else if ( !uiDynamic->potaEdit->text().isEmpty() )
    {
        potaEditFinished();
    }
    else if ( !uiDynamic->wwffEdit->text().isEmpty() )
    {
        wwffEditFinished();
    } 
}
...
void NewContactWidget::potaEditFinished()
{
    ...
    QStringList potaList = uiDynamic->potaEdit->text().split("@");
    QString potaString;
    ...
    else if ( !uiDynamic->sotaEdit->text().isEmpty() )
    {
        sotaEditFinished();
    }
    else if ( !uiDynamic->wwffEdit->text().isEmpty() )
...
void NewContactWidget::wwffEditFinished()
{
    ...
    if ( wwffInfo.reference.toUpper() == uiDynamic->wwffEdit->text().toUpper()
